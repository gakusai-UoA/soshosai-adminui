...
const TEAM_DOMAIN = process.env.REACT_APP_TEAM_DOMAIN || args.context.cloudflare.env.RREACT_APP_TEAM_DOMAIN;
const AUD = process.env.REACT_APP_POLICY_AUD || args.context.cloudflare.env.RREACT_APP_POLICY_AUD;
console.log(AUD)
